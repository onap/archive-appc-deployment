...
SDNC_ADAPTORS_VERSION=${SDNC_ADAPTORS_VERSION:-0.1.1-SNAPSHOT}
SDNC_NORTHBOUND_VERSION=${SDNC_NORTHBOUND_VERSION:-0.1.1-SNAPSHOT}
SDNC_PLUGINS_VERSION=${SDNC_PLUGINS_VERSION:-0.1.1-SNAPSHOT}
